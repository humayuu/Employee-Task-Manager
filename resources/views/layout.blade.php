...
<body>
    ...
    <div id="main-wrapper">
        ...
        <div class="nav-header">
            <a href="index.html" class="brand-logo">
                ...
                <span class="brand-title"
                    style="font-size: 1.2rem; font-weight: 700; color: #fff; margin-left: 10px;">TASK MANAGER</span>
            </a>
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
                                    <img src="./images/profile/pic1.jpg" width="20" alt="Profile Image"
                                        style="border-radius: 50%;" />
                                    <div class="header-info ml-3">
                                        <span
                                            class="text-black"><strong>{{ Auth::user()->name ?? 'Admin' }}</strong></span>
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a href="{{ url('/change-password') }}" class="dropdown-item ai-icon">
                                        <svg id="icon-key" xmlns="http://www.w3.org/2000/svg" class="text-success"
                                            width="18" height="18" viewBox="0 0 24 24" fill="none"
                                            stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                            stroke-linejoin="round">
                                            <path
        ...
        <div class="deznav">
            <div class="deznav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="ai-icon" href="{{ url('/users') }}" aria-expanded="false">
                            <i class="flaticon-381-user-7"></i>
                            <span class="nav-text">Manage Users</span>
                        </a>
                    </li>
                    <li><a class="ai-icon" href="{{ url('/tasks/create') }}" aria-expanded="false">
                            <i class="flaticon-381-add-1"></i>
                            <span class="nav-text">Create Task</span>
                        </a>
                    </li>
                    <li><a class="ai-icon" href="{{ url('/tasks') }}" aria-expanded="false">
        ...
        <div class="footer">
            <div class="copyright">
                <p>Copyright © Designed &amp; Developed by <a href="https://github.com/humayuu"
                        target="_blank">Humayun</a> 2026</p>
            </div>
        </div>
